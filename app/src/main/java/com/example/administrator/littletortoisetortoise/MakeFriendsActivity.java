...
public class MakeFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_makfriend);
        findId();
        intialToolBar();
        ...
        mPullRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                mhandler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(MakeFriendsActivity.this, "哈哈 刷新完成啦", Toast.LENGTH_SHORT).show();
      ...
      tb.setTitle("");
        ...
        tb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(MakeFriendsActivity.this,ActivityActivity.class);
