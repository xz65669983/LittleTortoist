...
public class HomePagerHeadFragment extends Fragment {
    private int postion;

    public static HomePagerHeadFragment getHomePagerFragmentInstance(int postion) {
        HomePagerHeadFragment hpf=new HomePagerHeadFragment();
